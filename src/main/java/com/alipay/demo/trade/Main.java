 ...
 *
 *         demo其实是很简单的  主要的类都在jar包里面了
 *         粘贴demo到工程中没问题说明 本工程的  alipay的配置是没有问题的
 */
public class Main {
...
[{"goods_id":"goods_id001","goods_name":"xxx小面包","quantity":1,"price":"10"},{"goods_id":"goods_id002","goods_name":"xxx牙刷","quantity":2,"price":"5"}],"operator_id":"test_operator_id","store_id":"test_store_id","extend_params":{"sys_service_provider_id":"2088100200300400500"},"timeout_express":"120m"}
2
​
格式化 压缩 开启JSONLint 点选JSON项时默认进行编辑
{
"out_trade_no": "tradeprecreate15293122295903897690",//外部订单号我们商城也会有一个的
"seller_id": "",//消费者id
"total_amount": "0.01",//总金额
"undiscountable_amount": "0",//不参加折扣的金额0元
"subject": "xxx品牌xxx门店当面付扫码消费",
"body": "购买商品3件共20.00元",
"goods_detail": [//购买的产品列表  一个数组
{
...
"extend_params": {  //扩展字段我们要使用的时候调用一下就好了
"sys_service_provider_id": "2088100200300400500"
},
"timeout_express": "120m"  //超时时间120min
}
 */
...
"code": "10000",//表示成功
"msg": "Success",
"out_trade_no": "tradeprecreate15293122295903897690",
"qr_code": "https://qr.alipay.com/bax00985saarvlpxltrf0096"
},
"sign": ""
}
 */